...
@Component({
  selector: 'app-cs-code-source',
  templateUrl: './cs-code-source.component.html',
})
export class CsCodeSourceComponent {
  htmlSource = `<cs-code>
  var x;
  if (1 == 2)
    x = 3;
...
directiveSource = `import { Directive, OnInit, Renderer2, ElementRef } from '@angular/core';
